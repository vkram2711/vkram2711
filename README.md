...
- **Healthcare chatbot** — conversational triage API for a Swedish clinic; cut manual support load by 30%
- **RAG edtech assistant** — knowledge base ingestion from text + video, deployed via Telegram; reduced lesson prep time by 25%
- **Battleships AI** — three-tier AI engine: random → Prolog-based heuristic hunt/cluster → probability heatmap. The heatmap one is genuinely hard to beat.
...
<!--
**vkram2711/vkram2711** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
